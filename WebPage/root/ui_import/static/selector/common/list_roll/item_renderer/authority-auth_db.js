//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db.js";
...
(function( url ){
	 ...
	 */
	var f = function( data ){
		window.TtwLog.timeStamp( "-- [ S ] - ./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db():void----------" );
		...
		window.TtwLog.timeStamp( "-- [ E ] - ./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db():void----------" );
	};
