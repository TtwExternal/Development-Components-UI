//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db_c.js";
...
(function( url ){
	 ...
	 */
	var f = function( data ){
		window.TtwLog.timeStamp( "-- [ S ] - ./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db_c():void----------" );
		...
		window.TtwLog.timeStamp( "-- [ E ] - ./ui_import/static/selector/common/list_roll/item_renderer/authority-auth_db_c():void----------" );
	};
