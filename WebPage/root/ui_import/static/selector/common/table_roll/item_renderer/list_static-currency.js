//----------------------------------------------------------------------------------------------------;
var fileNm = "./ui_import/static/selector/common/table_roll/item_renderer/list_static-currency.js";
...
(function( url ){
	 ...
	 */
	var f = function( data ){
		window.TtwLog.timeStamp( "-- [ S ] - ./ui_import/static/selector/common/table_roll/item_renderer/list_static-currency():void----------" );
		...
		window.TtwLog.timeStamp( "-- [ E ] - ./ui_import/static/selector/common/table_roll/item_renderer/list_static-currency():void----------" );
	};
