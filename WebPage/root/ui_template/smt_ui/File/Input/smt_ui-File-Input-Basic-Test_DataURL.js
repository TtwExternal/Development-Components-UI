...
(function( url, $el_div ){
	...
	var _addEvent = function()
	{
		...
		window.b2link.fileReader.single__DataURL.addEvent( _el_input__fileUploader, _el_button__fileUploader );
	};
	...
	var _removeEvent = function()
	{
		...
		//파일 업로더 UI에 이벤트 리스너를 추가한다;
		window.b2link.fileReader.single__DataURL.removeEvent( _el_input__fileUploader, _el_button__fileUploader );
	};
