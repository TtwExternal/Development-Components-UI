...
(function() {
	...
	qq.Error = function(message) {
		this.message = "[FileUploader] " + message;
	};
	...
	qq.basePublicApi = {
		...
		log: function(str, level) {
			if (this._options.debug && (!level || level === "info")) {
				qq.log("[FileUploader] " + str);
			} else if (level && level !== "info") {
				qq.log("[FileUploader] " + str, level);
			}
		},
		...
		setAllowedExtensions: function(newAllowedExtensions) {
			this._options.validation.allowedExtensions = newAllowedExtensions;
		},
		...
		setUrl: function(id, newUrl) {
			this._uploadData.updateUrl(id, newUrl);
		},
		setParams: function(params, id) {
			this._paramsStore.set(params, id);
		},
		setSizeLimit: function(newSizeLimit) {
			this._options.validation.sizeLimit = newSizeLimit;
		},
