...
window.b2link.STATIC.CONFIG.URL.SERVER = "http://localhost:49323/";
//window.b2link.STATIC.CONFIG.URL.SCODE = "development-components-ui::webserver";//시스템 개별 정의;
//window.b2link.STATIC.CONFIG.URL.SCODE = "SYS0015::webserver";//시스템 개별 정의;
window.b2link.STATIC.CONFIG.URL.SCODE = "SYS0015";//시스템 개별 정의;
